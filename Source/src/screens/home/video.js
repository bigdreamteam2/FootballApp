  ...
  render() {
    return (
      <View style={styles.container} onLayout={this._onLayout}>
        <TouchableOpacity style={{position:'absolute', top:0, left:0}} activeOpacity={0.3} onPress={() => { this._onClosePopup() }}>
          <Icon style={{marginLeft: 15, marginTop:15, color:"#fff"}} name="md-arrow-back" />
          {/* <IconAW style={{marginLeft: 15, marginTop:15, fontSize:20,color:"#fff"}} name="close" />     */}
        </TouchableOpacity>
        <View style={{ width: this.state.videoWidth, height: this.state.videoHeight, backgroundColor:'#000000' }}>
              ...
              }}>
              {
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <IconAW style={{fontSize:40,color:"#fff"}} name="play" />
                    {/* <Image
            ...
            this.state.showVideoControl ?
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <IconAW style={{marginLeft: 15,fontSize:20,color:"#fff"}} name={this.state.isPlaying ? "pause": "play"} />
                  {/* <Image
                ...
                <Slider
                  ...
                  thumbImage={require("./../../../assets/Icon/IconFootball/peru.png")}
                ...
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress() }}>
                  <IconAW style={{marginRight: 15,fontSize:20,color:"#fff"}} name="arrows-alt" />
                  {/* <Image
          ...
          {
            this.state.showVideoControl ?
              <View style={[styles.controlTitle, {width: this.state.videoWidth}]}>
                <Text numberOfLines={1} style={styles.titleVideo}>{this.state.titleVideo}</Text>
              </View> : null
          }
        </View>
